...
export const IconBrain = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z"/><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z"/><path d="M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4"/><path d="M17.599 6.5a3 3 0 0 0 .399-1.375"/><path d="M6.003 5.125A3 3 0 0 0 6.402 6.5"/><path d="M3.477 12.578c.07-1.225.244-2.453.526-3.678"/><path d="M19.997 8.9c.282 1.225.456 2.453.526 3.678"/><path d="M12.238 19c.041.288.086.581.138.885"/><path d="M11.624 19c-.041.288-.086.581-.138.885"/></svg>
);
...
export const IconSparkles = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/><path d="M5 3v4"/><path d="M9 3v4"/><path d="M3 7h6"/></svg>
);
...
export const IconGreamSkull = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    {/* Gemini Star (Top Right Corner) */}
    <path d="M20 2l1.5 3l3 1.5l-3 1.5l-1.5 3l-1.5-3l-3-1.5l3-1.5z" />
    
    {/* Happy Skull */}
    {/* Cranium */}
    <path d="M11 6c-4.4 0-8 3.1-8 7c0 1.9.8 3.7 2 5v2h10v-2c1.2-1.3 2-3.1 2-5c0-3.9-3.6-7-6-7z" />
    {/* Big Happy Eyes */}
    <circle cx="8" cy="13" r="1.5" />
    <circle cx="14" cy="13" r="1.5" />
    {/* Nose */}
    <path d="M11 16l-1 1.5h2z" />
    {/* Smile */}
    <path d="M7 19c1.5 1.5 6.5 1.5 8 0" />
  </svg>
);